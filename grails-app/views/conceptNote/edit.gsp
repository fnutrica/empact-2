...
<html>
	...
	<body>
		<a href="#edit-conceptNote" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-conceptNote" class="content scaffold-edit" role="main">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${conceptNoteInstance?.version}" />
				<fieldset class="form">
