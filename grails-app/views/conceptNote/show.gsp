...
<div id="show-conceptNote" class="content scaffold-show" role="main">
    ...
    <ol class="property-list conceptNote">
        ...
        <g:if test="${conceptNoteInstance?.description}">
            <li class="fieldcontain">
                <span id="description-label" class="property-label"><g:message code="conceptNote.description.label" default="Description" /></span>

                <span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${conceptNoteInstance}" field="description"/></span>
